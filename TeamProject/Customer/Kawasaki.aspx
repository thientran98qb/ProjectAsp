<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Kawasaki.aspx.cs" Inherits="TeamProject.Customer.Kawasaki" %>

<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <div class="jumbotron">
        <img alt="" src="../Photos/Kawasaki.jpg" style="width: 100%; height: 720px" />
    </div>
