<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" EnableEventValidation="false" AutoEventWireup="true" CodeBehind="QLQuyenhTK.aspx.cs" Inherits="TeamProject.Admin.QLQuyenhTK" %>
                ...
                <asp:GridView ID="GridAllStore"  runat="server" AutoGenerateColumns="False" Width="80%"  ViewStateMode="Enabled" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None">
                    <Columns>
                        <asp:TemplateField HeaderText="Chọn Sửa" >
                            <ItemTemplate>                              
                                    <asp:LinkButton ID="btnSelect" CssClass="btn btn-primary" runat="server" OnClick="btnSelect_Click" Text="Chọn Sửa"  CommandName='<% # Eval("ID_QUYEN") %>' />                        
                            </ItemTemplate>
                            <HeaderStyle HorizontalAlign="Center" />
                            <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                        <asp:BoundField HeaderText="Tên Quyền" DataField="TEN_QUYEN" >
                        <ItemStyle VerticalAlign="Middle" HorizontalAlign="Center" CssClass="text-center" />
                        </asp:BoundField>
                        <asp:TemplateField HeaderText="Xóa">
                             <ItemTemplate>                                
                              <asp:Button ID="btnDelete" CssClass="btn btn-danger"  runat="server"   OnClick="btnDelete_Click" Text="Xóa" CommandName='<% # Eval("ID_QUYEN") %>' />                  
                            </ItemTemplate>
                             <ItemStyle HorizontalAlign="Center" />
                        </asp:TemplateField>
                    </Columns>                    
